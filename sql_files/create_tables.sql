...
-- ALTER TABLE categories ADD CONSTRAINT cat_name_uni UNIQUE(cat_id, user_id);
-- move foreign key user_id to category

CREATE TABLE milestones
(
    mil_id           INTEGER         GENERATED BY DEFAULT ON NULL AS IDENTITY CONSTRAINT mil_pk PRIMARY KEY,
    mil_name         VARCHAR2 (30)   NOT NULL,
...
-- ALTER TABLE milestones ADD CONSTRAINT mil_name_uni UNIQUE(mil_name, cat_id);
