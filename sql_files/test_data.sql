...
INSERT INTO users (login, hash, salt) VALUES ('user3', 'd7111d2b45efda000f1d09a014f4d5763d5981f32126541ef7dda8e46c7fdf15', 'a1b2c3d4e5f6g7h8');
    INSERT INTO categories (cat_name, cat_description) VALUES ('Bazy Danych 2', 'Projektowanie aplikacji z bazami danych przy użyciu zaawansowanych mechanizmów');
        INSERT INTO milestones (mil_name, date_added, deadline, mil_completed, mil_description, user_id, cat_id) VALUES ('Egzamin', TO_DATE('2024/02/26 20:11:34'), TO_DATE('2024/06/17'), TO_DATE('2024/03/02 21:24:20'), 'Egzamin - wszystkie wykłady', 3, 3);
        ...
        INSERT INTO milestones (mil_name, date_added, deadline, mil_completed, mil_description, user_id, cat_id) VALUES ('Projekt', TO_DATE('2024/02/26 20:11:54'), TO_DATE('2024/06/24'), TO_DATE('2024/02/26 20:11:54'), 'Projekt - baza danych z aplikacją', 3, 3);
    ...
    INSERT INTO categories (cat_name, cat_description) VALUES ('Sztuka wytwarzania oprogramowania', 'Poszerzanie wiedzy umożliwiającej pisanie lepszego kodu');
        INSERT INTO milestones (mil_name, date_added, deadline, mil_completed, mil_description, user_id, cat_id) VALUES ('Kolokwium 1', TO_DATE('2024/02/26 20:21:54'), TO_DATE('2024/04/15'), NULL, NULL, 3, 4);
        ...
        INSERT INTO milestones (mil_name, date_added, deadline, mil_completed, mil_description, user_id, cat_id) VALUES ('Kolokwium 2', TO_DATE('2024/02/26 20:21:58'), TO_DATE('2024/06/03'), NULL, NULL, 3, 4);
    ...
    INSERT INTO categories (cat_name, cat_description) VALUES ('Systemy komputerowe w sterowaniu i pomiarach', 'Praca z mikrokontrolerami i systemami czasu rzeczywistego');
        INSERT INTO milestones (mil_name, date_added, deadline, mil_completed, mil_description, user_id, cat_id) VALUES ('Kolokwium 1', TO_DATE('2024/02/26 20:22:12'), TO_DATE('2024/04/08'), TO_DATE('2024/03/25 23:24:05'), NULL, 3, 5);
        ...
        INSERT INTO milestones (mil_name, date_added, deadline, mil_completed, mil_description, user_id, cat_id) VALUES ('Kolokwium 2', TO_DATE('2024/02/26 20:22:19'), TO_DATE('2024/06/03'), TO_DATE('2024/02/26 20:22:19'), NULL, 3, 5);
    ...
    INSERT INTO categories (cat_name, cat_description) VALUES ('Bezpieczeństwo systemów i sieci', 'Informacje z zakresu kryptografii i cyberbezpieczeństwa');
        INSERT INTO milestones (mil_name, date_added, deadline, mil_completed, mil_description, user_id, cat_id) VALUES ('Egzamin', TO_DATE('2024/02/26 20:22:52'), TO_DATE('2024/06/29'), NULL, NULL, 3, 7);
